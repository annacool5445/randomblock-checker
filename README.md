# randomblock-checker
randomblock-checker is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can randomblock-checker Project via npm:

```bash
npm install randomblock-checker
```
## Usage

const Web3Tools = require('randomblock-checker');
